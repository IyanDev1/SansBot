...
await conn.send3ButtonDoc(m.chat, mnya, text.trim(), `Sewa`, `${_p}sewa`, `Owner`, `${_p}owner`, `Speed`, `${_p}speed`, m, {  
      quoted: ftroli,  
      contextInfo: { forwardingScore: 99999, isForwarded: true,  
          externalAdReply: {  showAdAttribution: true, 
              title: 'SansBot MD By IyanDev',  
              body: '© SansBot', 
              description: 'SansBot MD', 
              mediaType: 2,  
            thumbnail: await (await fetch('https://telegra.ph/file/c9b6e3acb3e0f30d27c2a.jpg')).buffer(), 
           mediaUrl: `https://chat.whatsapp.com/INbLatNOc4b6X1Rqu0UI2y` 
          }  
       }  
      })
